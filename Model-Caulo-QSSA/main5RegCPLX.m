...
load('./LoadMatrices/opt_result.mat','para');
clc; clf; close all;  
...
% here to save format for mutant case
% 1 GcrA_Mutant.mat, 2 CcrM_Mutant.mat, 3 cdG_Mutant.mat, 4 PleD_Mutant.mat, 
% 5 PdeA_Mutant.mat, 6 DnaA_Mutant.mat, 7 SM921_Mutant.mat, 8 CtrA3_Mutant.mat, 
% 9 Prediction1.mat, 10 Prediction2.mat, 11 Prediction3.mat, 12 Prediction4.mat

save('./LoadMatrices/model_result.mat', 'tout', 'yout')

%  init = yout(end,:);
%  save('./LoadMatrices/init.mat', 'init')

%  mutantPlotterFinal(tout, yout)
load("./LoadMatrices/model_result.mat","tout","yout")
graphCellCycleFinal(tout, yout)
