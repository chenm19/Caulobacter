function [] = graphCellCycle(tout, yout)
%%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&%
% Script for plotting results of Caulobacter cell cycle model. 
% Input tout and yout from numberical integration
%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&%
...
tpCpdRtot = [0*0.937, 20*0.937,40*0.937,60*0.937,80*0.937,100*0.937,120*0.937, 140*0.937, 160*0.937] + 1200;
...
line(tout, yout(:,CpdR)+yout(:,CpdRP), 'Color', 'k', 'LineWidth', 2, 'Linestyle', '-');

hold on;
box on;
% plot(tpCpdRP, scaled_pCpdRP, 'ro', 'MarkerFaceColor', 'r')
% plot(tpCpdR, scaled_pCpdR, 'ro', 'MarkerFaceColor', 'r')
plot(tpCpdRtot, scaled_pCpdRtot, 'ro', 'MarkerFaceColor', 'r')
